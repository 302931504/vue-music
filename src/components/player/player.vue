      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disablePlay">
              <i @click="prev" class="icon-prev"></i>
            </div>
            <div class="icon i-center" :class="disablePlay">
              <i @click="togglePlay" :class="playIcon"></i>
            </div>
            <div class="icon i-right" :class="disablePlay">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      timeupdate (ev) {
        this.currentSongTime = ev.target.currentTime;
      },
      format (interval) {
        interval = interval | 0;
        let minite = interval / 60 | 0;
