<template>
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper" v-show="songs.length > 0" ref="player">
    ...
    @scroll="scroll" class="list" ref="songList">
      <div class="song-list-wrapper">
        <song-list :songs="songs" @select="selectSong" :rank="rankType"></song-list>
      </div>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.minHeight = -this.bgImageHeight + 40;
